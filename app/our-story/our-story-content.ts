...
const englishCopy = {
  metadata: {
    ...
    description:
      "Tetiaroa's story did not begin with Marlon Brando. See how his ecological hope became the accountable work of Tetiaroa Society.",
  },
  hero: {
    title: "Dedicated to the promise",
    description:
      "Marlon Brando was so moved by this place, that he spent his remaining years trying to protect it. Tetiaroa Society continues his mission.",
    videoLabel: "Tetiaroa Society film, playing silently",
    filmLabel: "Play the film",
    filmRuntime: "1:13",
    filmRuntimeLabel: "1 minute 13 seconds",
    filmNote: "A short film on how the Tetiaroa Society came to be.",
  ...
  handoff: {
    eyebrow: "An idea gains a structure",
    title: "A promise is only as serious as the work behind it.",
    body:
      "Brando supported archaeological fieldwork on Tetiaroa in 1972–73. Still, protecting an atoll takes more than one person's conviction. It takes people, rules, facilities, long records, and the humility to change course when the island tells you something is not working.",
    timeline: [
      {
        year: "1961",
        title: "The encounter",
        body: "Brando reaches Tetiaroa during the filming of Mutiny on the Bounty in French Polynesia.",
      },
      {
        year: "1967",
        title: "The acquisition",
        body: "He acquires the atoll. His hope for an ecological model will become part of Tetiaroa's modern story.",
      },
      {
        year: "1972–73",
        title: "Learning from the past",
        body: "Brando supports archaeological fieldwork and a field school for Tahitian students.",
      },
      {
        year: "2010",
        title: "The Society",
        body: "Tetiaroa Society is founded to carry education, conservation, and research forward on the atoll.",
      },
      {
        year: "2014–2016",
        title: "A place and a plan",
        body: "The Ecostation is completed in 2014. The published draft Conservation and Sustainable Use Plan follows in 2016.",
      },
      {
        year: "Today",
        title: "The daily test",
        body: "Field teams, educators, scientists, partners, and donors test the promise against what actually happens on the atoll.",
      },
    ],
  },
  practice: {
    eyebrow: "What the Society is here to do",
    title: "Care for the whole atoll—and prove the care is working.",
    intro:
      "Tetiaroa's owners designated the Society as the atoll's environmental steward. Stewardship is not a title. It must show up in the condition of the reef, the motu, the species, and the knowledge carried forward.",
    items: [
      {
        number: "01",
        title: "Help living systems recover",
        body: "Reduce invasive pressure, protect nesting beaches, strengthen biosecurity, and follow the recovery of land and lagoon together.",
      ...
      {
        number: "03",
        title: "Protect more than habitat",
        body: "Keep Polynesian history, language, traditional knowledge, archaeology, and living community relationships present in how Tetiaroa is understood.",
        href: "/pillars/education-culture",
        action: "Education + culture",
      },
      {
        number: "04",
        title: "Do not let the learning stop here",
        body: "Guide resort guests into the atoll's nature and culture, and connect students, researchers, partners, and island communities so useful knowledge does not remain on one motu.",
  ...
  plan: {
    eyebrow: "The conservation framework",
    title: "This is where ideals meet decisions.",
    body:
      "The 2016 Conservation and Sustainable Use Plan set out a shared framework for research, coral reefs, turtles, birds, vegetation, cultural heritage, water, waste, invasive species, and responsible human use. A plan earns its value in daily decisions: what is protected, what is measured, what must change, and who remains accountable.",
    documentNote: "Published document · Draft dated March 18, 2016 · 84 pages",
    documentLabel: "Read the conservation plan",
    documentHref:
      "https://www.tetiaroasociety.org/sites/default/files/research-docs/Tetiaroa-CASUP.pdf",
  },
  horizon: {
    eyebrow: "The trajectory",
    title: "One atoll. Lessons meant to travel.",
    lead:
      "Tetiaroa is where the work is tested. It is not where the responsibility ends.",
    body:
      "The Society's direction is to understand and restore this place deeply enough that the learning becomes useful beyond it—helping island and coastal communities face global change without separating ecological resilience from cultural continuity.",
    steps: [
      {
        label: "Protect",
        title: "Start with one whole place",
        body: "Care for reef, lagoon, motu, wildlife, culture, and human use as parts of one connected system.",
      },
      {
        label: "Learn",
        title: "Pay attention to what changes",
        body: "Bring traditional knowledge, field experience, and scientific research together—and stay willing to be corrected.",
      },
      {
        label: "Share",
        title: "Let the learning leave the island",
        body: "Turn tested practice into partnerships, education, and tools other communities can adapt to their own places—not copy blindly.",
      },
    ],
  },
  sources: {
    ...
    items: [
      {
        ...
        note: "Tetiaroa Society",
        href: "https://www.tetiaroasociety.org/island/history-culture/brief-history",
      },
      {
        label: "The long-term history of Tetiaroa",
        note: "Journal of Pacific Archaeology · 2019",
      ...
      {
        label: "Conservation and Sustainable Use Plan",
        note: "Tetiaroa Society · 2016 draft",
        href: "https://www.tetiaroasociety.org/sites/default/files/research-docs/Tetiaroa-CASUP.pdf",
      },
      {
        label: "Tetiaroa Society programs",
        note: "Research, conservation, education, and guiding",
        href: "https://www.tetiaroasociety.org/programs",
      },
    ],
  },
  closing: {
    eyebrow: "The next chapter is already in the field",
    title: "A promise survives by becoming work.",
    body:
      "Follow what the team is learning now, meet the people doing it, and help carry the work forward.",
    impactLabel: "Explore the Impact Feed",
